            ...
            <Row className="wrap-info">
              <Col span={12}>
                ...
                <Space className="info-item">
                  ...
                  <div className="content-right">{info?.ngaySinh ? moment(info.ngaySinh).format('DD-MM-YYYY') : 'Chưa cập nhật'}</div>
                </Space>
                <Space className="info-item">
                  <div className="title-left">Giới tính: </div>
                  <div className="content-right">{
                    info?.gioiTinh === 1 ? 'Nam' : info?.gioiTinh === 2 ? 'Nữ' : info?.gioiTinh === 3 ? 'Khác' : 'Chưa cập nhật'
                  }</div>
                </Space>
              </Col>
              <Col span={11}>
                <Space className="info-item">
                  ...
                  <div className="content-right">{info?.phanQuyen === "ADMIN" ? "Quản trị viên" : "Người dùng"}</div>
                </Space>
                <Space className="info-item">
                ...
                <Space className="info-item">
                  ...
                  <div className="content-right">{info?.sdt || 'Chưa cập nhật'}</div>
                </Space>
                <Space className="info-item"> 
                <div className="title-left">Địa chỉ: </div>
                <div className="content-right">{info?.diaChi || 'Chưa cập nhật'}</div>
                </Space>
              </Col>
            </Row>
            </div>
