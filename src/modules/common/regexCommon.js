...
const replaceAccentedCharactersByLowerCase = (content) => {
...
export const filterSelect = (value, option) => {
...
export const hasPermission = (TabIDs, listTab) => {
