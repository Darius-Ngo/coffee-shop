import { Form, Input, Button, DatePicker, Col, Row, Radio, Select, Upload, Spin } from 'antd';
...
const ModalAddUser = (props) => {
    ...
    return (
        <Modal
            ...
            width={600}
            title={props.user ? "Sửa thông tin người dùng" : "Thêm thông tin người dùng"}
            footer={
            ...
            <div className="wrap-form__register">
                ...
                >
                    <Row gutter={10}>
                        ...
                        >
                        <Input className="input-item" allowClear placeholder="tên tài khoản" />
                        </Form.Item>
                        </Col>
                        <Col span={12}>
                        <Form.Item
                        ...
                        >
                            <Input.Password className="input-item" placeholder="mật khẩu"/>
                        </Form.Item>
                        </Col>
                    </Row>
                    <Row gutter={10}>
                        ...
                        >
                        <Input id='hoTen' className="input-item" allowClear placeholder="họ tên" />
                        </Form.Item>
                        </Col>
                        <Col span={12}>
                        <Form.Item
                        ...
                        >
                            <Input id='email' className="input-item" allowClear placeholder="nhập emai"/>
                        </Form.Item>
                        </Col>
                    </Row>
                    <Row gutter={10}>
                    ...
                    <Row gutter={10}>
                        ...
                        name="sdt"
                        >
                        <Input id='sdt' className="input-item" allowClear placeholder="số điện thoại" />
                        </Form.Item>
                        </Col>
                        <Col span={12}>
                        <Form.Item
                        ...
                        name="phanQuyen"
                    >
                        <Select style={{ width: '100%' }} placeholder="chọn phân quyền">
                    ...
                    >
                      ...
                      >
                        <Button className="btn-upload-avatar" icon={<UploadOutlined />}></Button>
                      </Upload>
                    </Form.Item>
                    <Form.Item
                        label='Địa chỉ'
